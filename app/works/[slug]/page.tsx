    ...
    <main className="mould-page">
      ...
      <article>
        <section className="mould-hero">
          ...
          <img className="mould-hero-image" src="/figma-assets/cases/mould-ui/hero.png" alt="Mould UI 设计系统" />
        </section>
        ...
        <section className="mould-body">
          ...
          <div className="mould-system-cards">
            {systemCards.map(([color, title, english, icon, detail]) => (
              <article style={{ background: color }} key={title}>
                ...
                <div><img src={`${media}/${icon}`} alt="" /><p>{detail}</p></div>
              </article>
            ))}
          </div>

          <div className="mould-text mould-section-title"><h2>明确设计原则</h2><p>在设计和开发组件库规范之前，先确定设计原则以践行设计价值观过程中行之有效的向导或提示。</p></div>
          <figure className="mould-rounded"><img src={`${media}/content-01.jpg`} alt="Mould UI 设计原则" /></figure>
          <figure className="mould-stack">
            {[2, 3, 4].map(n => <img key={n} src={`${media}/content-0${n}.png`} alt={`Mould UI 全局配置 ${n - 1}`} />)}
          </figure>
          <figure className="mould-rounded"><img src={`${media}/content-05.png`} alt="Mould UI 组件系统" /></figure>
          ...
          {[6, 7, 8, 9].map(n => (
            <figure className="mould-platform" key={n}><img src={`${media}/content-0${n}.${n === 6 ? "jpg" : "png"}`} alt={`Mould UI 平台展示 ${n - 5}`} /></figure>
          ))}
        ...
        <section className="mould-more">
          ...
          <div>
            <a className="directory-card" href="/works/huochebang-shipper-app" aria-label="View project: 货车帮｜货主端 APP">
              <img src="/figma-assets/work-truck.png" alt="" />
            ...
            <a className="directory-card" href="/works/greater-bay-airlines" aria-label="View project: 大湾区航空｜移动应用">
              <img src="/figma-assets/work-airline.png" alt="" />
...
function CaseHero({ title, role, team, time, image }: CaseHeroProps) {
  return (
    <section className="case-hero">
      ...
      <img className="case-hero-image" src={image} alt={title} />
    </section>
  );
}
...
function SouthwestKaiaPage() {
  ...
  return (
    <main className="case-page southwest-page">
      ...
      <SiteHeader />
      <article>
        <CaseHero title="西南凯亚｜品牌VI" role="负责前期的量化质化调研、用户访谈、概念化草稿、设计和交付。" team="10名设计师、若干名决策领导层。" time="2019/08" image={`${southwestMedia}/hero.png`} />
        <section className="case-body">
          ...
          {firstMedia.slice(0, 3).map(n => <figure className="case-media" key={n}><img src={`${southwestMedia}/content-0${n}.png`} alt={`西南凯亚品牌设计过程 ${n}`} /></figure>)}
          ...
          {firstMedia.slice(3).map(n => <figure className="case-media" key={n}><img src={`${southwestMedia}/content-0${n}.png`} alt={`西南凯亚调研与探索 ${n}`} /></figure>)}
          <div className="case-text case-section-title"><h2>方案探索</h2><p>对标识的思考本质上是设计师头脑中的思维导图，将所有抽象词汇转化为SYMBOL每个人都可以联想到。并逐步形成草图及绘制。</p></div>
          <figure className="case-media"><img src={`${southwestMedia}/content-07.gif`} alt="西南凯亚标识方案动态探索" /></figure>
          <figure className="case-media"><img src={`${southwestMedia}/content-08.png`} alt="西南凯亚标识方案" /></figure>
          {[9, 11, 12].map(n => <figure className="case-media" key={n}><img src={`${southwestMedia}/content-${String(n).padStart(2, "0")}.${n < 10 ? "png" : "jpg"}`} alt={`西南凯亚品牌视觉 ${n}`} /></figure>)}
          ...
          <figure className="case-media"><img src={`${southwestMedia}/content-13.png`} alt="西南凯亚品牌基本准则" /></figure>
          <div className="case-media-pair">
            {[14, 15].map(n => <figure className="case-media" key={n}><img src={`${southwestMedia}/content-${n}.png`} alt={`西南凯亚品牌应用 ${n}`} /></figure>)}
          </div>
          <figure className="case-media"><img src={`${southwestMedia}/content-16.png`} alt="西南凯亚品牌应用" /></figure>
          <div className="case-media-pair">
            {[17, 18].map(n => <figure className="case-media" key={n}><img src={`${southwestMedia}/content-${n}.jpg`} alt={`西南凯亚品牌应用 ${n}`} /></figure>)}
          </div>
          <figure className="case-media"><img src={`${southwestMedia}/content-19.jpg`} alt="西南凯亚品牌应用全景" /></figure>
          <CaseCta />
        </section>
        <CaseMore>
...
function GreaterBayAirPage() {
  return (
    <main className="case-page airline-page">
      ...
      <SiteHeader />
      <article>
        <CaseHero title="大湾区航空｜移动应用" role="负责功能竞品调研、概念化、客户沟通、设计和交付。" team="2名设计师、4名产品经理和若干名前端工程师。" time="2021/08" image={`${airlineMedia}/hero-1.5x.png`} />
        <section className="case-body">
          ...
          <div className="airline-task-cards">
            {[
              ...
              <article key={title}><img src={`${airlineMedia}/${icon}`} alt="" /><div><h3>{title}</h3><p>{copy}</p></div></article>
            ))}
          </div>
        ...
        <CaseMore>
          <ProjectCard slug="zentao" image="/figma-assets/work-zentao.png" eyebrow="禅道全新品牌与产品体验设计" title="禅道｜产品设计" />
          <ProjectCard slug="southwest-kaiya" image="/figma-assets/work-rebrand.png" eyebrow="西南凯亚品牌视觉升级" title="西南凯亚｜品牌VI" />
        </CaseMore>
      </article>
      <SiteFooter />
      <PortfolioNav active={null} />
...
function StaticMedia({ base, count, ext = "jpg", label }: { base: string; count: number; ext?: string; label: string }) {
  return <>{Array.from({ length: count }, (_, i) => <figure className="case-media" key={i}><img src={`${base}/content-${String(i + 1).padStart(2, "0")}.${ext}`} alt={`${label} ${i + 1}`} /></figure>)}</>;
}
...
function KaiyaAcademyPage() {
  return (
    <main className="case-page academy-page">
      ...
      <article>
        <CaseHero title="凯亚学院｜品牌VI" role="负责前期调研、问卷及访谈、洞察及收敛、概念化草稿、设计和交付。" team="1名设计师和1名直属领导干系人" time="2020/06" image={`${academyMedia}/hero.png`} />
        <section className="case-body">
          ...
          <figure className="case-media"><img src={`${academyMedia}/content-01.png`} alt="凯亚学院品牌调研" /></figure>
          ...
          <figure className="case-media case-media-stack">{[2, 3].map(n => <img key={n} src={`${academyMedia}/content-0${n}.jpg`} alt={`凯亚学院品牌洞察 ${n - 1}`} />)}</figure>
          ...
          <figure className="case-media"><img src={`${academyMedia}/content-04.jpg`} alt="凯亚学院品牌设计策略" /></figure>
          <figure className="case-media"><img src={`${academyMedia}/content-05.png`} alt="凯亚学院标识系统" /></figure>
          <figure className="case-media case-media-stack">{[6, 7].map(n => <img key={n} src={`${academyMedia}/content-0${n}.jpg`} alt={`凯亚学院品牌系统 ${n}`} />)}</figure>
          ...
          {[8, 9, 10].map(n => <figure className="case-media" key={n}><img src={`${academyMedia}/content-${String(n).padStart(2, "0")}.png`} alt={`凯亚学院视觉应用 ${n - 7}`} /></figure>)}
          <div className="case-media-pair">{[11, 12].map(n => <figure className="case-media" key={n}><img src={`${academyMedia}/content-${n}.png`} alt={`凯亚学院品牌应用 ${n}`} /></figure>)}</div>
          <figure className="case-media"><img src={`${academyMedia}/content-13.png`} alt="凯亚学院品牌应用全景" /></figure>
          <CaseCta />
        </section>
        <CaseMore>
          <ProjectCard slug="southwest-kaiya" image="/figma-assets/work-rebrand.png" eyebrow="西南凯亚官方品牌重塑" title="西南凯亚｜品牌VI" />
          <ProjectCard slug="manbang-insurance" image="/figma-assets/work-insurance.png" eyebrow="满帮保货车保险运营平台产品设计" title="满帮保｜B2B平台" />
        </CaseMore>
      </article>
...
function ManbangB2BPage() {
  return (
    <main className="case-page b2b-page">
      <SiteLoader /><SiteHeader />
      <article>
        <CaseHero title="满帮保｜B2B平台" role="负责视觉风格定位及后期产品优化。" team="1名UI设计师、1名产品经理" time="2018/08" image={`${b2bMedia}/hero.png`} />
        <section className="case-body">
        ...
        <CaseMore>
          ...
          <ProjectCard slug="huochebang-shipper-app" image="/figma-assets/work-truck.png" eyebrow="货车帮保险业务货主端APP设计" title="货车帮｜货主端APP" />
        </CaseMore>
      </article>
      <SiteFooter /><PortfolioNav active={null} />
    </main>
...
function TruckAppPage() {
  return (
    <main className="case-page truck-page">
      <SiteLoader /><SiteHeader />
      <article>
        <CaseHero title="货车帮 I 货主端APP" role="负责视觉风格定位及后期产品优化。" team="1名视觉设计师、1名交互设计师" time="2018/10" image={`${truckMedia}/hero.png`} />
        <section className="case-body">
        ...
        <CaseMore>
          <ProjectCard slug="manbang-insurance" image="/figma-assets/work-insurance.png" eyebrow="满帮保货车保险运营平台产品设计" title="满帮保｜B2B平台" />
          <ProjectCard slug="zentao" image="/figma-assets/work-zentao.png" eyebrow="禅道项目管理平台设计" title="禅道｜项目管理平台" />
        </CaseMore>
      </article>
      <SiteFooter /><PortfolioNav active={null} />
    </main>
...
function ZentaoPage() {
  return (
    <main className="case-page zentao-page">
      <SiteLoader /><SiteHeader />
      <article>
        <CaseHero title="禅道丨项目管理平台" role="负责视觉风格定位及前期评审，以为后期团队成员设计页面做铺垫。" team="3名视觉设计师、2名交互设计师和若干名前端工程师。" time="2017/08" image={`${zentaoMedia}/hero.png`} />
        <section className="case-body">
          <div className="case-text"><h2>概述</h2><p>禅道是一款国内的开源项目管理软件。专注研发项目管理、内置需求管任务管理及用例管理等项目管理功能，实现开发软件的完整生命周期管理平台。</p></div>
          {[1, 2].map(n => <figure className="case-media" key={n}><img src={`${zentaoMedia}/content-0${n}.jpg`} alt={`禅道项目管理平台设计 ${n}`} /></figure>)}
          {[3, 4, 5, 6, 7, 8].map(n => <figure className="case-media" key={n}><img src={`${zentaoMedia}/content-0${n}.png`} alt={`禅道项目管理平台界面 ${n}`} /></figure>)}
          <CaseCta />
        </section>
        <CaseMore>

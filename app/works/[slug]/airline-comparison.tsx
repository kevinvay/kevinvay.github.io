...
const image = "/figma-assets/cases/greater-bay-air/comparison-default-1.5x.webp";
...
export function AirlineComparison() {
  ...
  return (
    <figure className="airline-comparison" style={{ "--split": `${position}%` } as CSSProperties}>
      <OptimizedImage src={image} alt="大湾区航空应用改版后界面" />
      <div className="airline-comparison-before" aria-hidden="true"><OptimizedImage src={image} alt="" /></div>
